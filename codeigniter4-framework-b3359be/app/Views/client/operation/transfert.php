...
<div class="container">
    ...
    <p>
        <label for="telephone_destination">Numéro de téléphone du destinataire :</label>
        <input type="text" id="telephone_destination" name="telephone_destination" placeholder="Ex: 034XXXXXXX" required>
    </p>
    ...
    <div style="background: #e8f4fd; padding: 10px; margin-bottom: 10px;">
        <p>Frais de transfert : <span id="affichage-frais">0</span> Ar</p>
        <p>Total débité : <span id="affichage-total">0</span> Ar</p>
        <div id="message-erreur" style="color:red;"></div>
    </div>
    <button type="submit" id="btn-valider">Envoyer l'argent</button>
</form>
